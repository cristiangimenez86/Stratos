(function () {
    ...
    commonModule.provider('commonConfig', function () {
        this.config = {
            ...
            controllerStartActivateEvent: '',
            controllerActivateSuccessEvent: '',
            controllerActivateErrorEvent: '',
            spinnerToggleEvent: ''
        };
    ...
    function common($q, $rootScope, $timeout, commonConfig, logger) {
        ...
        function activateController(promises, controllerId) {
            ...
            return $q.all(promises)
                ...
                .catch(function (eventArgs) {
                    var logError = logger.getLogFn(controllerId, 'error');
                    logError(eventArgs.data.message);
                    $broadcast(commonConfig.config.controllerActivateErrorEvent, data)
                });
        }
